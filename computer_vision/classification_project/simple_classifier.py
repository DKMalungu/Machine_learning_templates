...
Keras includes a variety models pre-trained on ImageNet in its applications module. The pre-trained model we'll use is called VGG16.
"""

# Getting the pre-trained base (VGG16)
pretrained_base = tf.keras.models.load_model('./inputs/cv-course-models/vgg16-pretrained-base')
